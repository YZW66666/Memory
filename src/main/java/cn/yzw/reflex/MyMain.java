...
public class MyMain {
    ...
    public void test() {
        try {
            System.out.println(Class.forName("cn.yzw.reflex.Student"));
    ...
    public void test1() {
        try {
            Class myMain = Class.forName("cn.yzw.reflex.Student");
    ...
    public void test2() {
        try {
            //加载
            Class calzz = Class.forName("cn.yzw.reflex.Student");
            //获取所有字段
    ...
    public  void  test05(){
        try {
            Class c=Class.forName("cn.yzw.reflex.Student");
